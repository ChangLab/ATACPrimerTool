...
Description: Predicts optimal regions for ATAC qPCR primers. For a detailed overview of the method, please see the [publication](https://www.nature.com/articles/nmeth.4663).
